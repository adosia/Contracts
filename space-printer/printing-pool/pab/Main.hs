...
main = void $ Simulator.runSimulationWith handlers $ do
    ...
    -- void $ Simulator.activateContract (Wallet 1) PrintingPool
...
instance Builtin.HasDefinitions StarterContracts where
    getDefinitions = [PrintingPool]
    getSchema =  \case
        PrintingPool -> Builtin.endpointsToSchemas @PrintingPool.Schema
    getContract = \case
        PrintingPool -> SomeBuiltin (PrintingPool.contract @ContractError)
