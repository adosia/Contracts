...
main = void $ Simulator.runSimulationWith handlers $ do
    ...
    -- void $ Simulator.activateContract (Wallet 1) VestingContract
...
instance Builtin.HasDefinitions StarterContracts where
    getDefinitions = [VestingContract]
    getSchema =  \case
        VestingContract -> Builtin.endpointsToSchemas @VestingContract.Schema
    getContract = \case
        VestingContract -> SomeBuiltin (VestingContract.contract @ContractError)
